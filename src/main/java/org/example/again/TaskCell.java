...
//
//public class TaskCell extends ListCell<TaskClass> {
//
...
//
//        content = new HBox(10, checkBox, textBox, deleteBtn);
...
//
//            if (task.isCompleted()) {
//                titleLabel.setStyle("-fx-font-weight: bold; -fx-strikethrough: true; -fx-text-fill: gray;");
//            } else {
//                titleLabel.setStyle("-fx-font-weight: bold;");
//            }
//
